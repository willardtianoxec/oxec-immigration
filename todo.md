...
- [ ] 重构语言选择表单：第一语言（英语/法语）和第二语言（可选）
- [ ] 第一语言为英语时，显示IELTS/CELPIP/PTE选项
- [ ] 第一语言为法语时，显TEF/TCF选项
- [ ] 第二语言为英语时，显IELTS/CELPIP/PTE选项
- [ ] 第二语言为法语时，显TEF/TCF选项
- [ ] 第二语言不能与第一语言相同（条件禁用）
- [ ] 第二语言默认为“没有”
- [ ] 添加第二语言赋分规则（CLB 9-10: 6分/项，CLB 7-8: 3分/项，CLB 5-6: 1分/项，CLB 4以下: 0分/项）
- [ ] 实现双语言附加分规则（TEF/TCF CLB 7+ 且 IELTS/CELPIP/PTE CLB 5+ = 50分）
- [ ] 实现单语言高分附加分规则（TEF/TCF CLB 7+ 但 IELTS/CELPIP/PTE CLB 4以下或无 = 25分）
- [ ] 修复最高学历“请选择”文字颜色为黑色
- [ ] 修复加拿大教育“无”改为“没有”
- [ ] 修复海外工作经验去掉“请选择”，默认为“没有”
- [ ] 更新CRS计算器测试用例，包含第二语言场景
- [ ] 验证所有语言组合的赋分正确性
- [ ] 测试UI条件显示逻辑
- [ ] 保存检查点 - 完成双语言支持修改
