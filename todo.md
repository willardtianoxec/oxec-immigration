...
## FSW 语言成绩计算错误修复 (Current Sprint - Phase 33)
- [ ] 检查FSW第一语言赋分规则 - CLB 9及以上应该每项6分（24分）
- [ ] 检查FSW第二语言赋分规则 - CLB 5及以上应该4分
- [ ] 修复CLB换算逻辑 - 确保IELTS 8/7/7/7都正确转换为CLB 9
- [ ] 修复TEF成绩换算 - 500分应该对应CLB 8及以上
- [ ] 测试修复后的赋分 - 验证第一语言24分+第二语言4分=28分
- [ ] 保存检查点 - 完成FSW语言成绩计算错误修复
